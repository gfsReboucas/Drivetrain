...
/* change the active subvar file:
var subVarFiles4 = new Array('./NREL_5MW_scaled.subvar', './NREL_5MW_reference.subvar');
Spck.currentModel.subvarset.setFile(subVarFiles4);
var subVarRoles4 = new Array(1, 0);
Spck.currentModel.subvarset.setRole(subVarRoles4);
*/
// NOTE: It is recommended to save, close and reload the model after this operation.
//       However this code is not automatically enabled, because it might destroy your original model.
//       Please remove the comment signs of the following lines, if you want to enable saving here.
// Spck.currentModel.save();
// Spck.currentModel.close();
// Spck.openModel('W:/Drivetrain/@NREL_5MW/NREL_5MW_reference.spck');
