...
%                      'dynamic_model', @Dynamic_Formulation};
    ...
    methods(Static)
        function brg = bearing(idx)
            ...
            % +-----------+--------------------------+-------+--------+-------+--------+---------+-----------+-----------+-----------+-----------------+------------------+------+------+------+-----+
            % |   INP-A   |     SKF C 30/1250 MB*    |  10/3 |        |       |        |         |    0.0    |   1.5e10  |   1.5e10  |      5.0e6      |       5.0e6      | CARB | 1750 | 1250 | 375 |
            % +-----------+--------------------------+-------+--------+-------+--------+---------+-----------+-----------+-----------+-----------------+------------------+------+------+------+-----+
            ...
            switch(idx)
                case 0 % Main shaft
                    INP_A     = Bearing('name', 'INP_A', 'type'  ,  'CARB', 'x'      , 333.0, ...
                                        'a'   ,       a, 'C'     ,     0.0e3, 'e'      , 0.28, ...
                                        'X'   , [0.0 0.0], 'Y'     , [0.0 0.0], 'L_10'   , L_10, ...
                    ...
                    INP_B     = Bearing('name', 'INP_B', 'type'  , 'SRB'  , 'x'      , 1166.0, ...
