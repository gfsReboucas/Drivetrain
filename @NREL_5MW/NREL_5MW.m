...
%                      'dynamic_model', @Dynamic_Formulation};
    ...
    methods(Static)
        function brg = bearing(idx)
            ...
            switch(idx)
                case 0 % Main shaft
                    INP_A     = Bearing('name', 'INP_A', 'type'  ,  'CARB', 'x'      , 1.0/3.0, ...
                    ...
                    INP_B     = Bearing('name', 'INP_B', 'type'  , 'SRB'  , 'x'      , 7.0/6.0, ...
...
%                     L_3 = 1500.0;
    ...
    methods
        function update_subvar(obj, varargin)
            ...
            fprintf(new_ID, "   subvar($_width, str= '$SVG_housing.$_width_ref*$SVG_stage_01.$_gamma_mn')                   ! $SVG_housing.$_width\n");
